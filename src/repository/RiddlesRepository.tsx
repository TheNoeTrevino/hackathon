const RiddlesRepo = [
  ...
  {
    question:
      "You can hear me, feel me and know that I’m there. But you’ll never ever ever find me. What am I?",
  ...
  {
    question:
      "You can get your jack-o’-lantern here, or you can use it to fix a hole in your pumpkin. What is it?",
  ...
  {
    question:
      "What is red, juicy, and delicious but could be poisonous that is offered by the wrong witch?",
    answerChoices: [
      "A tomato",
      "Snow White’s apple",
      "A cherry",
  ...
  {
    question:
      "Eye of newt and toe of frog, Wool of bat? Just a spot. These are all that witches brew inside this big black pot. What is it?",
    answerChoices: ["A kettle", "A cauldron", "A pot", "A stove"],
    answer: "A cauldron",
  },
  {
    question:
      "Oz had good ones from the north and south, and wicked ones from the east and west, but flying around on a broomstick is probably how I’m known the best. What am I?",
    answerChoices: ["A witch", "A fairy", "A goblin", "A dragon"],
    answer: "A witch",
  },
  {
    question:
      "A group of witches are having a broomstick race. The witch in third place overtakes the witch in second place. Where is she now?",
    answerChoices: [
      "First place",
      "Second place",
      "Third place",
  ...
  {
    question:
      "From the head down to toes, through every living being I flow. Vampires love me but some people might faint when they see me though! What am I?",
  ...
  {
    question:
      "Ghosts and vampires will come looking for me on a dark autumn night and, with a ding and a buzz, will eagerly wait with open arms for me. What am I?",
  ...
  {
    question:
      "A vampire’s biggest fear, but a chef’s favorite ingredient. What is it?",
  ...
  {
    question:
      "Often buried with fabulous wealth an undead creature am I, all wrapped up in myself. What am I?",
    answerChoices: ["A ghost", "A zombie", "A mummy", "A witch"],
    answer: "A mummy",
  },
  {
    question:
      "Made out of different body parts. Brought to life by electricity. Bolts in my neck and yellowish skin. Why can’t people show me some pity? Who am I?",
